...
this.needsYTApiForAutoplay=navigator.vendor.includes("Apple")||navigator.userAgent.includes("Mobi")}/**
     ...
     */static addPrefetch(e,t,n){let a=document.createElement("link");a.rel=e,a.href=t,n&&(a.as=n),document.head.append(a)}/**
...
customElements.define("lite-youtube",e),function(){let e=document.getElementById("copyright"),t=new Date().getFullYear();e.innerHTML=`<p class='text-white text-center'>&copy; ${t} <a class='text-white text-center' href='https://kingdomone.co/' target='_blank'>Kingdom One</a> <br/> All Rights Reserved.</p>`}()}();//# sourceMappingURL=index.967dfc3a.js.map

//# sourceMappingURL=index.967dfc3a.js.map
